...
abstract class ChannelNoticeService
{
    abstract protected function defaultChannel(): string;
     ...
     * } $payload
     */
    public function createFromPayload(array $payload): Notice
    {
        return DB::transaction(function () use ($payload): Notice {
            ...
            if ($installation) {
                ...
                $installation = Installation::create([
                    ...
                    'notes' => 'Creada automaticamente desde '.$this->sourceLabel().'.',
                    'status' => 'active',
                ]);
            }
            ...
            $notice = Notice::create([
                ...
                'contact_name' => $contactName,
                'contact_phone' => $phone,
                'channel' => filled($payload['origen'] ?? null) ? $payload['origen'] : $this->defaultChannel(),
    ...
    private function customerNotes(array $payload): ?string
    {
        ...
        return 'Cliente creado automaticamente desde '.$this->sourceLabel().'. Tipo indicado: '.$type.'.';
    }
    ...
    private function fullDescription(array $payload): string
    {
        $lines = [
            ...
            '',
            'Origen: '.(filled($payload['origen'] ?? null) ? $payload['origen'] : $this->defaultChannel()),
